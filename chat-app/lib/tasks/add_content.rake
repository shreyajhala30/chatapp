namespace :ChatApp do
  desc "This task is used to create admin user"
  task :add_content => :environment do
    a = AppDoc.all
    a = a.present? ? a.first : AppDoc.new
    a.privacy = '<p>This privacy policy governs your use of the software application&nbsp;Chat App (&ldquo;Application&rdquo;) for mobile devices that was created by&nbsp;Developer Salima Witt.&nbsp;The Application is&nbsp;a platform to send customized angel characters along with custom-written messages to friends and family.</p>
<p>What information does the Application obtain and how is it used?</p>
<p>This section is designed to inform Users of the types of data that the app obtains and how that information is used. You&#39;ll find several types of data that are often obtained by apps, but you should provide Users with a clear, illustrative list of the most important data points obtained by your app.</p>
...
<p>Alternative language if you don&#39;t allow unregistered users: &quot;Registration with us is mandatory in order to be able to use the basic features of the Application.&quot; (On the other hand, you might want to specify you don&#39;t let user register at all, but still list the information you collect).</p>
<p>Mobile application developers should be aware that certain types of data, for example, medical records and certain types of financial information may be subject to existing privacy law, or any other current or future state, federal law, regulation, restriction, etc. Application developers creating apps that collect potentially sensitive information are encouraged to obtain counsel to ensure that their data collection policies are in line with current law in the jurisdiction(s) where the app may be used. If you collect credit card information, we strongly encourage you seek the advice of a professional to ensure PCI compliance and other specific security requirements.&nbsp;</p>
...
<p>This list is not comprehensive. Adjust it according to what your app actually asks for.</p>
...
<p>If the Application collects information from and/or for social networking platforms (e.g., pulling contact information, friends lists, login information, photos or check-ins) you should ensure that the prior consent of the user is obtained.&nbsp;</p>
...
<p>Again, this list is not comprehensive. Adjust it according to what your app actually asks for.</p>
<p>&nbsp;</p>
<p>Does the Application collect precise real time location information of the device?</p>
<p>This section is only applicable if the Application collects precise, real-time location information. Geo-targeting (e.g., zip code or city) data should be also addressed in the section above (&ldquo;Automatically Collected Information&quot;. If your app DOES NOT use geolocation, check out the generic parent of this document here: https://www.docracy.com/6016/mobile-privacy-policy</p>
<p>When you visit the mobile application, we may use GPS technology (or other similar technology) to determine your current location in order to determine the city you are located within and display a location map with relevant advertisements. We share your current location with other users or partners.</p>
<p>This only a sample description. Change the above paragraph it according to what your app actually does with geolocated data (e.g. allow tagging, check-in) and, if applicable, describe the circumstances where precise location data is shared with third parties for their independent use.</p>
...
<p>Generally, app developers will want to have the right to transfer information collected by the app under certain circumstances. For example, if the app developer sells the app, the developer may want that information collected by the application transferred as part of the sale. While some of the more common examples of data transfer to third parties are provided, you are encouraged to work with counsel and/or privacy professional to determine if other examples should be included in the policy.</p>
...
<ul>
  ...
  <li>
  <p>if&nbsp;Salima Witt&nbsp;is involved in a merger, acquisition, or sale of all or a&nbsp;portion of its assets, you will be notified via email and/or a prominent notice on our Web site of any change in ownership or uses of this information, as well as any choices you may have regarding this information.</p>
  </li>
</ul>
<p>If your app works with advertisers and analytics companies your policy needs to have an Automatic Data Collection and Advertising section. Check out the specific branch here: LINK</p>
<p>&nbsp;</p>
<p>What are my opt-out rights?</p>
<p>If your app uses geolocation or taps into advertising services, check the appropriate branches linked above.</p>
...
<p>By using the Application, you are consenting to our processing of your information as set forth in this Privacy Policy now and as amended by us. &quot;Processing,&rdquo; means using cookies on a computer/hand held device or using or touching information in any way, including, but not limited to, collecting, storing, deleting, using, combining and disclosing information, all of which activities will take place in the&nbsp;United States. If you reside outside the&nbsp;United States&nbsp;your information will be transferred, processed and stored there under&nbsp;United States&nbsp;privacy standards.&nbsp;</p>'
    ...
    a.tos = '<p><strong>Chat App Terms of Use</strong></p>
<p><strong>(Effective as of Nov 2014)</strong></p>
<p>Welcome to the Chat App service(the &ldquo;Service&rdquo;). The following Terms of Use apply when you view or use the Service. Please review the following terms carefully. By accessing or using the Service, you signify your agreement to these Terms of Use. If you do not agree to these Terms of Use, you may not access or use the Service.</p>
<p><strong>PRIVACY POLICY</strong></p>
<p>The Company respects the privacy of its Service users. Please refer to the Company&rsquo;s Privacy Policy which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to this Privacy Policy.</p>
<p><strong>ABOUT THE SERVICE</strong></p>
<p>The Service allows you to send customized angel characters along with custom-written messages to friends and family.</p>
...
<p>&middot; post any information that is abusive, threatening, obscene, defamatory, libelous, or racially, sexually, religiously, or otherwise objectionable and offensive;</p>
<p>&middot; use the service for any unlawful purpose or for the promotion of illegal activities;</p>
...
<p>&middot; make any automated use of the system, or take any action that we deem to impose or to potentially impose an unreasonable or disproportionately large load on our servers or network infrastructure;</p>
<p>&middot; bypass any robot exclusion headers or other measures we take to restrict access to the Service or use any software, technology, or device to scrape, spider, or crawl the Service or harvest or manipulate data; or</p>
<p>&middot; publish or link to malicious content intended to damage or disrupt another user&rsquo;s browser or computer.</p>
...
<p>&middot; You are solely responsible for your account and the activity that occurs while signed in to or while using your account;</p>
<p>&middot; You will not post information that is malicious, false or inaccurate;</p>
<p>&middot; You will not submit content that is copyrighted or subject to third party proprietary rights, including privacy, publicity, trade secret, etc., unless you are the owner of such rights or have the appropriate permission from their rightful owner to specifically submit such content; and</p>
<p>&middot; You hereby affirm we have the right to determine whether any of your User Content submissions are appropriate and comply with these Terms of Service, remove any and/or all of your submissions, and terminate your account with or without prior notice.</p>
...
<p>We may also use your email address, to send you other messages, including information about the Company and special offers. You may opt out of such email by changing your account settings or sending an email to Salima Witt</p>
...
<p>These Terms of Use and your use of the Site are governed by the federal laws of the United States of America and the laws of the State, without regard to conflict of law provisions.</p>
